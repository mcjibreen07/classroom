            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        Notes
                        <a href="http://localhost/classroom/classRoom.php?" class="float-right">Back</a>
                    </div>
...
$ID = 1; // Replace this with the desired student ID or get it from user input, etc.

$stmt = $conn->prepare("SELECT * FROM `tbl_notes` WHERE `Studentid` = :studentId");
$stmt->bindParam(':studentId', $ID, PDO::PARAM_INT); // Bind the parameter to avoid SQL injection
$stmt->execute();
